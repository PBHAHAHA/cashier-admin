module.exports = {
    ...
    // 这里时配置规则的,自己看情况配置
    rules: {
        "no-undef":"off", // 此规则可以帮助您定位由于变量和参数名称拼写错误或意外隐式全局变量（例如，由于忘记for循环初始化程序中的var关键字）而导致的潜在参考错误
        "vue/multi-word-component-names": "off",//组件命名检查
        ...
        "vue/attributes-order": "off",//标签属性顺序检查
        "vue/html-closing-bracket-newline": "off",//右侧闭合尖括号换行检查
        // 要求html标签的缩进为需要4个空格
        "vue/html-indent": [
            "off",
            4,
